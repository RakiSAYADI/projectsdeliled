...
const uint8_t MAC_BASE_ADDRESS[8] = {0x70, 0xB3, 0xD5, 0x01, 0x82, 0x07};
...
void BaseMacInit()
{
	...
	ESP_LOGI(MAC_TAG, "MAC:%02X:%02X:%02X:%02X:%02X:%02X",
			 MAC_BASE_ADDRESS[0], MAC_BASE_ADDRESS[1], MAC_BASE_ADDRESS[2],
			 MAC_BASE_ADDRESS[3], MAC_BASE_ADDRESS[4], MAC_BASE_ADDRESS[5]);
