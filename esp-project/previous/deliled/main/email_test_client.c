...
void payloadTestBuild()
{
	...
	for (i=0;i<6;i++)
	{
    	...
    	sprintf(payload_text[4],"Subject: Maestro [%s] Email de test \r\n",UnitCfg.UnitName);
    	sprintf(payload_text[5],"\r\n");// empty line to divide headers from body, see RFC5322
    	sprintf(payload_text[6],"Bonjour,\r\n");
    	sprintf(payload_text[7],"Voici un email test envoyé depuis votre application Maestro™ . \r\n");
    	sprintf(payload_text[8],"Si votre qualité de l'air est médiocre vous recervez une nouvelle notification.\r\n");
    	sprintf(payload_text[9],"Merci d'utiliser l'application intelligente Maestro™ !\r\n");
