...
class _DataViewModificationState extends State<DataViewModification> {
  Color _checkBoxEnabled = Colors.green;
  ...
  String _myEndDataTimeDayData = '31';
  String _myEndDataTimeMonthData = '12';
  String _myEndDataTimeYearsData = '2025';
  ...
  ToastyMessage _myUvcToast = ToastyMessage();
  ...
  void initState() {
    ...
    _myUvcToast = ToastyMessage();
    _myUvcToast.setContext(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CheckboxListTile(
                    ...
                    value: _allData,
                    onChanged: (bool? newValue) => _onAllDataChanged(newValue!),
                ...
                Padding(
                  ...
                  child: CheckboxListTile(
                    ...
                    value: _timedData,
                    onChanged: (bool? newValue) => _onTimedDataChanged(newValue!),
                    controlAffinity: ListTileControlAffinity.leading,
                  ),
                ),
                Visibility(
