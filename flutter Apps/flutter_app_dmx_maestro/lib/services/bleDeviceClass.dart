...
class Device {
  ...
  Future<void> writeCharacteristic(int servicePosition, int charPosition) async {
    // checking MTU
    // checking Connection
  ...
  Future<void> writeDescriptor(int servicePosition, int charPosition, int descPosition) async {
    // checking MTU
    // checking Connection
    // writing descriptor
  }

  Future<void> readDescriptor(int servicePosition, int charPosition, int descPosition) async {
    // checking MTU
    // checking Connection
    // reading descriptor
  }
