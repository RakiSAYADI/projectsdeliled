              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          Icons.warning,
                          size: MediaQuery.of(context).size.width * 0.1 * MediaQuery.of(context).size.height * 0.001,
                          color: Colors.white,
                        ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: MediaQuery.of(context).size.width * 0.1 * MediaQuery.of(context).size.height * 0.0005,
                          ),
                        ),
                      ],
                    ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Expanded(flex: 1, child: SizedBox(width: MediaQuery.of(context).size.width * 0.01)),
                      Container(
                        child: Container(
                          width: 100,
                          height: 100,
