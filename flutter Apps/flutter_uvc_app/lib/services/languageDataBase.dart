...
final List<String> establishmentHintTextLanguageArray = ['Établissement', 'Establishment'];

final List<String> userHintTextLanguageArray = ['Opérateur', 'Operator'];

final List<String> roomHintTextLanguageArray = ['Pièce/local', 'Room / room'];
...
final List<String> ruleNumberThreeTextLanguageArray = [
  ...
  'Indicate the disinfection in progress thanks to the hangers and / or the easel.'
];
...
final List<String> fourTutorialBodyTextLanguageArray = [
  ...
  'Then enter disinfection data such as company name, '
      'operator name and duration of disinfection.'
];

final List<String> fiveTutorialTitleTextLanguageArray = ['C\'est presque fini !', 'It\'s almost done !'];
...
final List<String> stopDisinfectAlertDialogMessageTextLanguageArray = ['Voulez-vous vraiment annuler le traitement UVC ?', 'Are you sure you want to cancel UVC treatment ?'];
...
final List<String> scanBLEDevicesPageTitleTextLanguageArray = ['Liste des UVC-LIGHT :', 'List of UVC-LIGHT:'];

final List<String> sendEmailPageTitleTextLanguageArray = ['Envoi Rapport', 'Sending Report'];
...
final List<String> uvcEmailObjectTextLanguageArray = ['Rapport de désinfection UVC', 'UVC disinfection report'];
...
final List<String> uvcEmailMessageTextLanguageArray = [
  ...
  'Hello, Hello,\n\n'
      'Enclosed you will find the report regarding the disinfection performed '
      'using your DEEPLIGHT® disinfection solution from DeliTech Medical®.\n'
      'This email is sent automatically, please do not reply to it.\n\n'
      'Thank you for your confidence.'
];

final List<String> sendEmailValidToastTextLanguageArray = ['Email bien envoyé , Vérifiez votre boite de reception !', 'Email sent, Check your inbox!'];

final List<String> sendEmailNotValidToastTextLanguageArray = ['Email n\'est pas envoyé , Vérifiez votre addresse email !', 'Email is not sent, Check your email address !'];
...
final List<List<List<String>>> uvcDefaultData = [
  ...
  [
    ['Robot name', 'User', 'Establishment', 'Room', 'Activation time', 'Activation date', 'Disinfection time (in seconds)', 'State']
  ]
];
...
List<String> deviceConnectButtonTextLanguageArray = ['Conecter', 'Connect'];
