...
final List<String> attentionAlertDialogTextLanguageArray = [
  'La connexion est perdue avec votre dispositif, vous allez être reconnecté',
  'The connection is lost with your device, you will be reconnected'
];

final List<String> checkConnectionAlertDialogTextLanguageArray = ['Connexion en cours', 'Connexion in progress'];
...
final List<String> humidityLanguageArray = ['Humidité', 'Humidity'];

final List<String> brightnessLanguageArray = ['Luminosité', 'Brightness'];

final List<String> co2LanguageArray = ['CO2', 'CO2'];
...
final List<String> averageAirQualityMessageLanguageArray = ['Moyen', 'Average'];

final List<String> goodAirQualityMessageLanguageArray = ['Bon', 'Good'];
...
final List<String> changeNameButtonTextLanguageArray = ['Changer le nom', 'Change name'];

final List<String> cycleCTextLanguageArray = ['Cycle Circadien :', 'Circadian Cycle :'];

final List<String> cycleCInfoTextLanguageArray = [
...
final List<String> dissociateTextLanguageArray = ['Dissocier', 'Dissociate'];
...
final List<String> passwordTextLanguageArray = ['Mot de passe :', 'Password'];
