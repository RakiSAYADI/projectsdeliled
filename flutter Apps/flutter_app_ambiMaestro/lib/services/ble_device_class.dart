        ...
        case BluetoothDeviceState.disconnected:
          if (homePageState) {
            Get.defaultDialog(
              ...
              content: Text(attentionAlertDialogTextLanguageArray[languageArrayIdentifier], style: const TextStyle(fontSize: 14)),
              actions: [
                TextButton(
                  child: Text(understoodTextLanguageArray[languageArrayIdentifier], style: const TextStyle(fontSize: 14)),
                  onPressed: () {
                    Get.clearRouteTree();
                    myDevice!.disconnect();
                    homePageState = false;
